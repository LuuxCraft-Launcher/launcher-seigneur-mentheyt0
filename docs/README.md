...
<h1 align="center">launcher de seigneur mentheyt0</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `Launcher-de-seigneur_mentheyt0-win-x64.exe ` |
| macOS | `Launcher-de-seigneur_mentheyt0-mac-universal.dmg` |
| Linux x64 | `Launcher-de-seigneur_mentheyt0-linux-x86_64.AppImage` |
